...
class ChannelEventDetail(BaseModel):
    ...
    one_of_schemas: List[str] = Field(default=Literal["ChildCreatedEvent", "ForcedNotificationChangedEvent", "NameChangedEvent", "ParentChangedEvent", "PinAddedEvent", "PinRemovedEvent", "SubscribersChangedEvent", "TopicChangedEvent", "VisibilityChangedEvent"])
